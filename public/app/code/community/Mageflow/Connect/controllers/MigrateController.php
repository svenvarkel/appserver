...
//            $this->getLogger()->log($changesetItem->getId());
        ...
        foreach ($changesetItemList as $changesetItem) {
            ...
            switch ($changesetItem->getType()) {
                ...
                case "catalog:category" :
                    Mage::helper('mageflow_connect/handler_catalog_category')->handle(
                        $filteredData
                    );
                    break;
                case "catalog:resource_eav_attribute" :
                    Mage::helper('mageflow_connect/handler_catalog_attribute')->handle(
                        $filteredData
                    );
                    break;
                case "system:configuration" :
                    Mage::helper('mageflow_connect/handler_system_configuration')->handle(
                        $filteredData
                    );
                    break;
                case "eav:entity_attribute_set" :
                    Mage::helper('mageflow_connect/handler_catalog_attributeset')->handle(
                        $filteredData
                    );
                    break;
            }
    ...
    {
        /**
         * @var Mageflow_Connect_Model_Resource_Changeset_Item_Collection $collection
         */
